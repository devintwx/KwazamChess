...
public class BoardSquare {
    ...
    public BoardSquare(int row, int col) {
        ...
        if ((row + col) % 2 == 0) {
            this.defaultBackground = new Color(181, 153, 132); // Light Brown color
        } else {
            this.defaultBackground = new Color(242, 227, 211); // Cream color
        }
    }
    ...
    public void resetBackgroundColor() {
        this.defaultBackground = ((rowPosition + colPosition) % 2 == 0) 
            ? new Color(245, 222, 179) // Cream
            : new Color(165, 42, 42);  // Light brown
    }
